...
Everyone engaged in the OpenAI CLI Assistant project’s codebases, issue trackers, chat rooms and mailing lists is compelled to follow the [code of conduct](https://github.com/KnowmeGPT/openai-cli-a